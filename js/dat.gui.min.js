...
dat.GUI = dat.gui.GUI = function(e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
    ...
    function p(a, d, c) {
        ...
        } else if (c instanceof b) g.bind(d, "click", function() { g.fakeEvent(c.__checkbox, "click") }), g.bind(c.__checkbox, "click", function(a) { a.stopPropagation() });
    ...
    function I(a) {
        ...
        g.bind(d, "click", function() { a.save() });
    ...
    g.bind(window, "keydown", function(a) { document.activeElement.type !== "text" && (a.which === 72 || a.keyCode == 72) && k.toggleHide() }, false);
    i.extend(k.prototype, {
        ...
        getSaveObject: function() {
            ...
            a.folders = {};
            i.each(this.__folders, function(b, c) { a.folders[c] = b.getSaveObject() });
            return a
        },
        save: function() {
        ...
        revert: function(a) {
            ...
            i.each(this.__folders, function(a) { a.revert(a) });
    ...
    Object.defineProperty(j.prototype, "a", {
        ...
        set: function(a) { this.__state.a = a }
    });
